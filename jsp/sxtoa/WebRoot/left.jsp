		...
		<c:if test="${sessionScope.emp.empType == 2 }">			
			<dd>
				...
				<ul class="menuson">
					...
					<li><cite></cite><a href="EmployeeServlet?method=toAdd" target="rightFrame">添加员工1</a><i></i></li>
			...
			<dd>
				...
				<ul class="menuson">
					<li><cite></cite><a href="duty/dutyAdd.jsp" target="rightFrame">签到签退1</a><i></i></li>
