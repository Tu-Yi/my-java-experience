	...
	<head>
		...
		<script type="text/javascript">
			$(function(){
				//通过Ajax获取所有的部门列表并输出
				$.ajax({
					url:"/sxtoa/DutyServlet?method=findAllDept",
					type:"POST",
				...
				$("#btn1").click(function(){
					...
					$.ajax({
						url:"/sxtoa/DutyServlet?method=findDuty",
						type:"POST",
				...
				$("#btn2").click(function(){
					...
					location.href="/sxtoa/DutyServlet?method=exportXls&empId="+empId+"&deptno="+deptno+"&dtDate="+dtDate;
